<h2><a href="https://leetcode.com/problems/sum-of-scores-of-built-strings/?envType=problem-list-v2&envId=dsa-recursion-maze-rolling-hash">2223. Sum of Scores of Built Strings</a></h2><h3>Hard</h3><hr><p>You are <strong>building</strong> a string <code>s</code> of length <code>n</code> <strong>one</strong> character at a time, <strong>prepending</strong> each new character to the <strong>front</strong> of the string. The strings are labeled from <code>1</code> to <code>n</code>, where the string with length <code>i</code> is labeled <code>s<sub>i</sub></code>.</p>
